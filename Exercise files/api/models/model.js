 ...
 */
class Person {
    constructor(name, age, isActive, createdAt = new Date()) {
        this.name = name;          // string
        this.age = age;            // number
        this.isActive = isActive;  // boolean
        this.createdAt = createdAt; // optional date
    }
}
...
/* Task 1 - Part 2. Replace these three instances of the example Class Resource with instances
   of your own class */
model.add(new Person("Magor", 23, true, new Date('2025-08-26')));
model.add(new Person("Bob", 30, false, new Date('2025-08-25')));
model.add(new Person("Charlie", 40, true, new Date('2025-08-24')));
